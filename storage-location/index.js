...
router.post('/', authorize([Role.SuperAdmin, Role.Admin, Role.Staff]), schema, controller.create);
router.put('/:id', authorize([Role.SuperAdmin, Role.Admin, Role.Staff]), schema, controller.update);
router.delete('/:id', authorize([Role.SuperAdmin, Role.Admin, Role.Staff]), controller._delete);
