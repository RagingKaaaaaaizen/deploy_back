...
router.get('/receipts/check-orphaned', authorize([Role.SuperAdmin, Role.Admin, Role.Staff, Role.Viewer]), controller.checkOrphanedReceipts); // GET check for orphaned receipt references
